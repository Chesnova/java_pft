...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/trainings/java_pft/soap-sample/src/main/resources/geoipservice.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/trainings/java_pft/soap-sample/src/main/resources/geoipservice.wsdl");
        }
        WSDL_LOCATION = url;
    }
